...
def CBB_post_game(game_number):
	...
	home_player_stats.add_column("FG", justify="right")    # in fmt fg/fga
...
#	home_off_reb = CBB_event_data_json['boxscore']['teams'][1]['statistics'][7]['displayValue']  Not using this, using own ttl, w/o tm rebs
	...
	visitor_player_stats.add_column("FG", justify="right")    # in fmt fg/fga
...
def CBB_pre_game(game_number):
	...
	game_status = CBB_data_json['events'][game_number]['status']['type']['detail']          #Time of day, time & period, or Final
