...
2. Updates need to be made daily, run python3 -u ESPNNFLAPISqlite.py YYYYMMDD (date in YYYYMMDD format). Doing updates the next day after a game day works best.
