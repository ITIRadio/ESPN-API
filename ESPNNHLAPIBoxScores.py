...
#Usage: python3 ESPNNHLAPIBoxScores.py [optional date in YYYYMMDD format, one date only due to throttling errors]
...
if len(sys.argv) == 2:
	...
	url = "http://site.api.espn.com/apis/site/v2/sports/hockey/nhl/scoreboard?dates=" + date_arg
	try:
